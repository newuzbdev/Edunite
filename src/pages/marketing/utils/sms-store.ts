...
const generateFakeHistory = (): SMSRecord[] => {
  ...
  fakeRecords.push(
    ...
    },
    {
      ...
      message: 'Salom Dilshod Toshmatov! Ona tili kursi bo\'yicha imtihon 2024-01-15 kuni soat 10:00 da bo\'lib o\'tadi. Tayyorgarlik ko\'ring!',
      templateId: '4',
    ...
    },
    {
      ...
      message: 'Salom Zarina Qodirova! English - Advanced kursi bo\'yicha imtihon 2024-01-18 kuni soat 11:00 da bo\'lib o\'tadi. Tayyorgarlik ko\'ring!',
      templateId: '4',
      templateType: 'exam_notification',
      status: 'delivered',
      sentAt: daysAgo(2),
  ...
  fakeRecords.push(
    {
      ...
      message: 'Salom Madina Sobirova! IELTS tayyorlov kursi bo\'yicha imtihon 2024-01-19 kuni soat 09:00 da bo\'lib o\'tadi. Tayyorgarlik ko\'ring!',
      templateId: '4',
      templateType: 'exam_notification',
      status: 'sending',
  ...
  fakeRecords.push(
    {
      ...
      message: 'Hurmatli Kamola Rahimova! Sizning Ona tili kursingiz yakunlandi. Sertifikat olish uchun bizning ofisimizga keling.',
      status: 'delivered',
      sentAt: daysAgo(3),
    ...
    },
    {
      ...
      message: 'Salom Farhod Jalilov! Yangi English va Ona tili kurslarimiz haqida ma\'lumot olish uchun bizning veb-saytimizga tashrif buyuring.',
      status: 'delivered',
      sentAt: daysAgo(5),
    ...
    {
      id: '19',
      recipient: '+998901234585',
      recipientName: 'Dilbar Toshmatova',
      message: 'Salom Dilbar Toshmatova! Sizning English - Beginner kursingiz uchun 450,000 so\'mlik to\'lovingiz 2024-02-10 kuni muddati tugaydi. Iltimos, vaqtida to\'lov qiling.',
      templateId: '2',
      templateType: 'payment_reminder',
      status: 'delivered',
      sentAt: daysAgo(4),
    ...
    {
      id: '20',
      recipient: '+998901234586',
      recipientName: 'Sardor Valiyev',
      message: 'Salom Sardor Valiyev! Eslatib o\'tamiz, sizning Ona tili - O\'rta darsingiz 2024-01-20 kuni soat 16:00 da bo\'ladi. Keling!',
      templateId: '3',
      templateType: 'class_reminder',
      status: 'delivered',
      sentAt: daysAgo(1),
    ...
    {
      id: '21',
      recipient: '+998901234587',
      recipientName: 'Gulnora Karimova',
      message: 'Salom Gulnora Karimova! IELTS tayyorlov kursi bo\'yicha imtihon 2024-02-15 kuni soat 10:00 da bo\'lib o\'tadi. Tayyorgarlik ko\'ring!',
      templateId: '4',
      templateType: 'exam_notification',
      status: 'delivered',
      sentAt: daysAgo(2),
    ...
    {
      id: '22',
      recipient: '+998901234588',
      recipientName: 'Bobur Ismoilov',
      message: 'Bobur Ismoilov, tug\'ilgan kuningiz bilan! Sizga baxt, omad va muvaffaqiyatlar tilaymiz! Edunite jamoasi.',
      templateId: '5',
      templateType: 'birthday',
      status: 'delivered',
      sentAt: daysAgo(6),
      deliveredAt: deliveredAfter(daysAgo(6), 1),
    },
    {
      id: '23',
      recipient: '+998901234589',
      recipientName: 'Malika Yusupova',
      message: 'Salom Malika Yusupova! Sizning Rus tili - Boshlang\'ich kursingiz uchun 400,000 so\'mlik to\'lovingiz 2024-02-12 kuni muddati tugaydi. Iltimos, vaqtida to\'lov qiling.',
      templateId: '2',
      templateType: 'payment_reminder',
      status: 'delivered',
      sentAt: daysAgo(3),
    ...
    {
      id: '24',
      recipient: '+998901234590',
      recipientName: 'Feruza Alimova',
      message: 'Salom Feruza Alimova! Eslatib o\'tamiz, sizning English - Intermediate darsingiz 2024-01-22 kuni soat 18:00 da bo\'ladi. Keling!',
      templateId: '3',
      templateType: 'class_reminder',
      status: 'delivered',
      sentAt: daysAgo(1),
    ...
    {
      id: '25',
      recipient: '+998901234591',
      recipientName: 'Nigora Xasanova',
      message: 'Salom Nigora Xasanova! Edunite o\'quv markaziga xush kelibsiz. Bizning Ona tili va English kurslarimiz haqida ma\'lumot olish uchun biz bilan bog\'laning.',
      templateId: '1',
      templateType: 'welcome',
      status: 'delivered',
      sentAt: daysAgo(7),
      deliveredAt: deliveredAfter(daysAgo(7), 2),
    },
    {
      id: '26',
      recipient: '+998901234592',
      recipientName: 'Azizbek Usmonov',
      message: 'Salom Azizbek Usmonov! Matematika - 10-11 sinf kursi bo\'yicha imtihon 2024-02-20 kuni soat 11:00 da bo\'lib o\'tadi. Tayyorgarlik ko\'ring!',
      templateId: '4',
      templateType: 'exam_notification',
      status: 'delivered',
      sentAt: daysAgo(2),
    ...
    {
      id: '27',
      recipient: '+998901234593',
      recipientName: 'Javohir Karimov',
      message: 'Hurmatli Javohir Karimov! Bayramingiz bilan! Sizga va oilangizga baxt, omad va sog\'lik tilaymiz!',
      templateId: '6',
      templateType: 'holiday',
      status: 'delivered',
      sentAt: daysAgo(5),
    ...
    {
      id: '28',
      recipient: '+998901234594',
      recipientName: 'Kamola Rahimova',
      message: 'Salom Kamola Rahimova! Sizning Ona tili - Imtihon tayyorlov kursingiz uchun 500,000 so\'mlik to\'lovingiz 2024-02-18 kuni muddati tugaydi. Iltimos, vaqtida to\'lov qiling.',
      templateId: '2',
      templateType: 'payment_reminder',
      status: 'delivered',
      sentAt: daysAgo(3),
    ...
    {
      id: '29',
      recipient: '+998901234595',
      recipientName: 'Shohruh Mirzayev',
      message: 'Salom Shohruh Mirzayev! Eslatib o\'tamiz, sizning Fizika darsingiz 2024-01-25 kuni soat 17:00 da bo\'ladi. Keling!',
      templateId: '3',
      templateType: 'class_reminder',
      status: 'delivered',
      sentAt: daysAgo(1),
    ...
    {
      id: '30',
      recipient: '+998901234596',
      recipientName: 'Dilshoda Toshmatova',
      message: 'Salom Dilshoda Toshmatova! English Conversation kursi bo\'yicha yangi guruh ochildi. Ro\'yxatdan o\'tish uchun biz bilan bog\'laning.',
      status: 'delivered',
      sentAt: daysAgo(4),
      deliveredAt: deliveredAfter(daysAgo(4), 2),
    }
